...
<style>
    ...
    bottom: 0;
    left: 0;
    background: url(<?php $this->options->backImg();?>) center 0 no-repeat;
...
<span class="bName"><?php $this->options->title() ?></span>
		<nav class="hd-n">
...
<a href="/Design.html">实验室</a>&nbsp&nbsp&nbsp
...
<div id="title"class="title">
	...
	<div class="meta">
		<span><a><?php $this->author(); ?></a> | <?php $this->category(','); ?>发 | <?php echo art_count($this->cid); ?>字</span>
	</div>
<?php endif; ?>
